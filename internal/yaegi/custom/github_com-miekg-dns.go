...
func init() {
	Symbols["github.com/miekg/dns/dns"] = map[string]reflect.Value{
		...
		"DefaultMsgInvalidFunc":                 reflect.ValueOf(&dns.DefaultMsgInvalidFunc).Elem(),
		...
		"EDNS0REPORTING":                        reflect.ValueOf(constant.MakeFromLiteral("18", token.INT, 0)),
		...
		"EDNS0ZONEVERSION":                      reflect.ValueOf(constant.MakeFromLiteral("19", token.INT, 0)),
		...
		"ExtendedErrorCodeInvalidQueryType":     reflect.ValueOf(dns.ExtendedErrorCodeInvalidQueryType),
		...
		"ExtendedErrorCodeSignatureExpiredBeforeValid": reflect.ValueOf(dns.ExtendedErrorCodeSignatureExpiredBeforeValid),
		...
		"ExtendedErrorCodeSynthesized":                 reflect.ValueOf(dns.ExtendedErrorCodeSynthesized),
		"ExtendedErrorCodeToString":                    reflect.ValueOf(&dns.ExtendedErrorCodeToString).Elem(),
		"ExtendedErrorCodeTooEarly":                    reflect.ValueOf(dns.ExtendedErrorCodeTooEarly),
		"ExtendedErrorCodeUnableToConformToPolicy":     reflect.ValueOf(dns.ExtendedErrorCodeUnableToConformToPolicy),
		...
		"ExtendedErrorCodeUnsupportedNSEC3IterValue":   reflect.ValueOf(dns.ExtendedErrorCodeUnsupportedNSEC3IterValue),
		...
		"OpcodeStateful":                  reflect.ValueOf(constant.MakeFromLiteral("6", token.INT, 0)),
		...
		"RcodeStatefulTypeNotImplemented": reflect.ValueOf(constant.MakeFromLiteral("11", token.INT, 0)),
		...
		"SVCB_OHTTP":                      reflect.ValueOf(dns.SVCB_OHTTP),
		...
		"StatefulTypeEncryptionPadding":   reflect.ValueOf(dns.StatefulTypeEncryptionPadding),
		"StatefulTypeKeepAlive":           reflect.ValueOf(dns.StatefulTypeKeepAlive),
		"StatefulTypeRetryDelay":          reflect.ValueOf(dns.StatefulTypeRetryDelay),
		"StatefulTypeToString":            reflect.ValueOf(&dns.StatefulTypeToString).Elem(),
		...
		"StringToStatefulType":            reflect.ValueOf(&dns.StringToStatefulType).Elem(),
		...
		"TypeNXNAME":                      reflect.ValueOf(dns.TypeNXNAME),
		...
		"TypeRESINFO":                     reflect.ValueOf(dns.TypeRESINFO),
		...
		"EDNS0_REPORTING":     reflect.ValueOf((*dns.EDNS0_REPORTING)(nil)),
		...
		"EDNS0_ZONEVERSION":   reflect.ValueOf((*dns.EDNS0_ZONEVERSION)(nil)),
		...
		"MsgInvalidFunc":      reflect.ValueOf((*dns.MsgInvalidFunc)(nil)),
		...
		"NXNAME":              reflect.ValueOf((*dns.NXNAME)(nil)),
		...
		"RESINFO":             reflect.ValueOf((*dns.RESINFO)(nil)),
		...
		"SVCBOhttp":           reflect.ValueOf((*dns.SVCBOhttp)(nil)),
