...
func init() {
	Symbols["github.com/prometheus/client_golang/prometheus/prometheus"] = map[string]reflect.Value{
		...
		"MustNewConstHistogramWithCreatedTimestamp": reflect.ValueOf(prometheus.MustNewConstHistogramWithCreatedTimestamp),
		...
		"MustNewConstNativeHistogram":               reflect.ValueOf(prometheus.MustNewConstNativeHistogram),
		"MustNewConstSummary":                       reflect.ValueOf(prometheus.MustNewConstSummary),
		"MustNewConstSummaryWithCreatedTimestamp":   reflect.ValueOf(prometheus.MustNewConstSummaryWithCreatedTimestamp),
		...
		"NewConstHistogramWithCreatedTimestamp":     reflect.ValueOf(prometheus.NewConstHistogramWithCreatedTimestamp),
		...
		"NewConstNativeHistogram":                   reflect.ValueOf(prometheus.NewConstNativeHistogram),
		"NewConstSummary":                           reflect.ValueOf(prometheus.NewConstSummary),
		"NewConstSummaryWithCreatedTimestamp":       reflect.ValueOf(prometheus.NewConstSummaryWithCreatedTimestamp),
		...
		"WrapCollectorWith":                         reflect.ValueOf(prometheus.WrapCollectorWith),
		"WrapCollectorWithPrefix":                   reflect.ValueOf(prometheus.WrapCollectorWithPrefix),
		...
		"CollectorFunc":          reflect.ValueOf((*prometheus.CollectorFunc)(nil)),
